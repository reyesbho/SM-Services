package com.moments.catalogservice.controller;

import com.moments.catalogservice.dto.ClienteResponse;
import com.moments.catalogservice.dto.SaborResponse;
import com.moments.catalogservice.service.ClienteService;
import com.moments.catalogservice.service.SaborService;
...
public class CatalogController {
    ...
    @GetMapping("/cliente")
    public ResponseEntity getClientes(@RequestParam(value = "search", required = false) Optional<String> search){
